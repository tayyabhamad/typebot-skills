...
Forge blocks are modular integrations built using Typebot's SDK. They are defined by lower-case type names matching their integration ID (e.g. `"type": "cal-com"`, `"type": "perplexity"`, etc.) and require `credentialsId` and `action`.
